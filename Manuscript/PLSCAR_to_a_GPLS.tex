...
decomposition (see our Supplmental Material).
...
discuss here---but show in the Supplemental Material---how PLS-CA-R
provides the basis for numerous variations and broader generalizations.
...
Finally, we want to remind the reader to see the Supplemental Material,
where we show (1) how PLS-CA-R generalizes most cross-decomposition
