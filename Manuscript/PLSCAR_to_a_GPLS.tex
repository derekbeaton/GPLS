...
where complete disjunctive would be a ``crisp coding'' (CITE). We
introduce how to handle various data types as Section
\label{section:appex} progresses to more complex (and ``real world'')
problems.
