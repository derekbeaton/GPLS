...
PLS "regression" [@wold_soft_1975;
@wold_collinearity_1984; @wold_pls-regression_2001]. PLS
regression decomposition is an asymmetric and iterative method. The asymmetry is that one data table is privileged (i.e., treated as predictors). PLSR computes its solution iteratively---via alternating least squares, the SVD, or similar techniques---and makes use of deflation for both data tables.
...
a $J\times J$ matrix ${\mathbf W}$ positive definite matrices,
the GSVD decomposes 
${\mathbf X}$ as 
...
First the *observed* probabilities matrix is computed as
${\mathbf O}_{\mathbf X} = 
...
\end{equation}
The *expected* probabilities matrix is computed as 
${\mathbf E}_{\mathbf X} 
