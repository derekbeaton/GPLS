...
\end{equation}
where ${\mathbf T}_{\mathbf X}{\mathbf B}\widetilde{\mathbf V}^{T} = \widetilde{\mathbf Z}_{\mathbf X} (\widetilde{\mathbf Z}_{\mathbf X}^{T}\widetilde{\mathbf Z}_{\mathbf X})^{+} \widetilde{\mathbf Z}_{\mathbf X}^T\widetilde{\mathbf Z}_{\mathbf Y}$. This connection to OLS shows how to residualize (i.e., "regress out" or "correct") for known confounding effects, akin to how residuals are computed in OLS. We do so with the original ${\mathbf Z}_{\mathbf Y}$ as ${\mathbf Z}_{\mathbf Y} - \widehat{\mathbf Z}_{\mathbf Y}$. PLS-CA-R produces both a predicted and a residualized version of ${\mathbf Y}$. Recall that $\widehat{{\mathbf Z}}_{\mathbf Y} = {\mathbf M}^{\frac{1}{2}}_{\mathbf Y}{\mathbf T}_{\mathbf X}{\mathbf B}\widetilde{\mathbf V}^{T}{\mathbf W}^{\frac{1}{2}}_{\mathbf Y}$. We compute a reconstituted form of ${\mathbf Y}$ as 
\begin{equation}
