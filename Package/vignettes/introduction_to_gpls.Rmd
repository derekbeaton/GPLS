...
- "Exploring optimizations and ridge regularization": which provides a few examples of how to dive more deeply into the core of GPLS by using different weights (constraints) to produce different optimizations, and how those weights naturally lead to ridge-like regulariztion.
